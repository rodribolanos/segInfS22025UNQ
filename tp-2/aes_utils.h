...
#define BLOCK_SIDE 4 // Dimension del bloque de bytes
...
extern unsigned char mix_col_matrix[BLOCK_SIDE][BLOCK_SIDE];
...
void addRoundKey(unsigned char state[BLOCK_SIDE][BLOCK_SIDE], unsigned char expanded_key[BLOCK_SIDE][BLOCK_SIDE]);
void subByte(unsigned char state[BLOCK_SIDE][BLOCK_SIDE]);
